...
PATH_ERRORS = "data/errors"
PATH_GARBAGE_URLS = "data/garbage_urls"
PATH_SECTIONS_FILE = "data/sources/medias_urls_v*.json"
FILE_PATH_EXTRACTION_ERRORS = "data/extraction_errors.txt"
#FILE_PATH_PROMPT_ROLE_KEYS = os.path.join(PATH_DATA, "role_prompt_keys.txt")
FILE_PATH_PROMPT_ROLE_SUMMARY = "data/role_prompt_body.txt"
# Data structures
ORDER_KEYS = (
    "url",
    "media_url",
